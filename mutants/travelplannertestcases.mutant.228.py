...
class TestItinerary(unittest.TestCase):
    def setUp(self):
        self.itinerary = Itinerary(datetime.date(2023, 5, 10), datetime.date(2023, 5, 20))
...
class TestTravelPlanner(unittest.TestCase):
    ...
    def test_plan_trip(self):
        itinerary_details = self.planner.plan_trip(datetime.date(2023, (5+1), 10), datetime.date(2023, 5, 20), ["Paris"], [("Hilton Paris", "double", "2023-05-10", "2023-05-15")])
