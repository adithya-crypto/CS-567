...
class TravelPlanner:
    ...
    def plan_trip(self, start_date, end_date, destination_names, accommodation_bookings):
        ...
        for acc_name, room_type, acc_start_date, acc_end_date in accommodation_bookings:
            if acc_name in self.accommodations:
                itinerary.add_booking(self.accommodations[ room_type,acc_name], acc_start_date, acc_end_date)
